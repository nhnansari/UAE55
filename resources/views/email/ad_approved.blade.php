                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="logo" style="text-align: center;">
                                <h1><a href="#">{{SiteSettings::title()}}</a></h1>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: center;">
                                    <h2>Ad Approved</h2>
                                    <h3>You ad has been approved and is listed at {{SiteSettings::title()}} </h3>
                                    <p><a href="{{ SiteSettings::webUrl() }}" class="btn btn-primary">Visit {{SiteSettings::title()}}</a></p>
                                </div>
                            </td>
                        </tr>
                    </table>
